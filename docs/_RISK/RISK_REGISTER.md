...
### R-ReviewerAgreement · 다중 reviewer 합의 실측·운영 절차 부재(protocol+packet 코드만)  — Severity: MEDIUM (신규 2026-06-24 · ADR#45 — adversarial 권고; ADR#46 packet scaffold 부분진전)
...
### R-GoldSamplingBias · gold sampling 대표성·oversampling 실데이터 부재(bucket+packet 코드만)  — Severity: MEDIUM (신규 2026-06-24 · ADR#45 — adversarial 권고; ADR#46 packet sampling 부분진전)
